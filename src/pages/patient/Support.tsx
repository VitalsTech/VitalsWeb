...
const FAQ_ITEMS = [
  {
    q: 'Как подключить Госуслуги?',
    a: 'На экране входа нажмите «Войти через Госуслуги» или подключите аккаунт в профиле, если уже вошли по телефону.',
  },
  {
    q: 'Где мои результаты анализов?',
    a: 'Результаты появляются в разделе «Документы».',
  },
  {
